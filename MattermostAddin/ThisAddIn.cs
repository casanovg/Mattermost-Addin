...
using MattermostAddinConnect.ContextMenu;
using MattermostAddinConnect.Error;
using MattermostAddinConnect.Http;
using MattermostAddinConnect.Mail;
using MattermostAddinConnect.Mattermost;
using MattermostAddinConnect.Reply;
using MattermostAddinConnect.Security;
        ...
        private void CheckVersions()
        {
            if (!Debugger.IsAttached)
            {
                ...
                MessageBox.Show(
                    ...
                    "MattermostAddin", MessageBoxButton.OK,
